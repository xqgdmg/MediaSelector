...
public class CustomCropView extends View {
    ...
    private int maskColor;//裁剪区域外图片颜色
    ...
    public CustomCropView setRadius(float radius) {
        this.radius = radius;
        post(new Runnable() {
            @Override
            public void run() {
    ...
    public CustomCropView setMaskColor(@ColorInt int maskColor) {
    ...
    public CustomCropView setBgColor(int bgColor) {
    ...
    public CustomCropView setBorderColor(@ColorInt int borderColor) {
    ...
    public CustomCropView setMaxScale(float maxScale) {
        if (maxScale < 1) {
            maxScale = 1;
        }
    ...
    public CustomCropView setDoubleClickScale(float doubleClickScale) {
    ...
    private void initAttr(AttributeSet attrs) {
        maskColor = Color.parseColor("#60ff0000");// TODO: 2020/6/8
        borderColor = ContextCompat.getColor(getContext(), android.R.color.white);
        if (attrs == null) {
            return;
        }

        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.CustomCropView);
        maskColor = typedArray.getColor(R.styleable.CustomCropView_maskColor, Color.parseColor("#60ff0000"));// TODO: 2020/6/8
        bgColor = typedArray.getColor(R.styleable.CustomCropView_bgColor, Color.WHITE);
        borderColor = typedArray.getColor(R.styleable.CustomCropView_borderColor, ContextCompat.getColor(getContext(), android.R.color.white));
        radius = typedArray.getDimension(R.styleable.CustomCropView_radius, 0);

        maxScale = typedArray.getFloat(R.styleable.CustomCropView_maxScale, 3f);
        doubleClickScale = typedArray.getFloat(R.styleable.CustomCropView_doubleClickScale, 1.8f);
...
//        touchRegion.setPath(bigCirclePath,new Region(0,0,getWidth(),getHeight()));
    ...
    public Bitmap clip() {
        ...
        canvas.drawColor(bgColor);//todo 是否需要背景颜色？
...
//                    circleRectFMatrix.mapRect(circleRectF);
    ...
    @Deprecated
    public CustomCropView setBitmap(Bitmap bitmap) {
        showBitmap = bitmap;
        resetBitmap();
        return this;
    }
    ...
    /*******************************************************************************************************/
    public CustomCropView setBitmap(int resId, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(getContext(), resId, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmap(String pathName, int reqWidth, int reqHeight) {
    ...
    @Deprecated
    public CustomCropView setBitmapToRotate(String pathName, int reqWidth, int reqHeight) {
        //内部已做旋转处理
        showBitmap = CropViewUtils.compressBitmap(pathName, reqWidth, reqHeight);
        resetBitmap();
...
//        }
    ...
    public CustomCropView setBitmap(byte[] data, int offset, int length, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(data, offset, length, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmap(FileDescriptor fd, Rect outPadding, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(fd, outPadding, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmap(Resources res, TypedValue value, InputStream is, Rect pad, int reqWidth, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmap(res, value, is, pad, reqWidth, reqHeight);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmap(InputStream is, Rect outPadding, int reqWidth, int reqHeight) {
    ...
    /*******************************************************************************************************/
    public CustomCropView setBitmapForHeight(int resId, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmapForHeight(getContext(), resId, reqHeight);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmapForHeight(String pathName, int reqHeight) {
    ...
    @Deprecated
    public CustomCropView setBitmapForHeightToRotate(String pathName, int reqHeight) {
        //内部已做旋转处理
        showBitmap = CropViewUtils.compressBitmapForHeight(pathName, reqHeight);
        resetBitmap();
//        int degree = CropViewUtils.readPictureDegree(pathName);
...
//        }
    ...
    public CustomCropView setBitmapForHeight(byte[] data, int offset, int length, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmapForHeight(data, offset, length, reqHeight);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmapForHeight(FileDescriptor fd, Rect outPadding, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmapForHeight(fd, outPadding, reqHeight);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmapForHeight(Resources res, TypedValue value, InputStream is, Rect pad, int reqHeight) {
        showBitmap = CropViewUtils.compressBitmapForHeight(res, value, is, pad, reqHeight);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmapForHeight(InputStream is, Rect outPadding, int reqHeight) {
    ...
    /*******************************************************************************************************/
    public CustomCropView setBitmapForWidth(int resId, int reqWidth) {
        showBitmap = CropViewUtils.compressBitmapForWidth(getContext(), resId, reqWidth);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmapForWidth(String pathName, int reqWidth) {
    ...
    @Deprecated
    public CustomCropView setBitmapForWidthToRotate(String pathName, int reqWidth) {
        //内部已做旋转处理
        showBitmap = CropViewUtils.compressBitmapForWidth(pathName, reqWidth);
        resetBitmap();
//        int degree = CropViewUtils.readPictureDegree(pathName);
...
//        }
    ...
    public CustomCropView setBitmapForWidth(byte[] data, int offset, int length, int reqWidth) {
        showBitmap = CropViewUtils.compressBitmapForWidth(data, offset, length, reqWidth);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmapForWidth(FileDescriptor fd, Rect outPadding, int reqWidth) {
        showBitmap = CropViewUtils.compressBitmapForWidth(fd, outPadding, reqWidth);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmapForWidth(Resources res, TypedValue value, InputStream is, Rect pad, int reqWidth) {
        showBitmap = CropViewUtils.compressBitmapForWidth(res, value, is, pad, reqWidth);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmapForWidth(InputStream is, Rect outPadding, int reqWidth) {
    ...
    /*******************************************************************************************************/
    public CustomCropView setBitmapForScale(int resId, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(getContext(), resId, scaleSize);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmapForScale(String pathName, int scaleSize) {
    ...
    @Deprecated
    public CustomCropView setBitmapForScaleToRotate(String pathName, int scaleSize) {
        //内部已做旋转处理
        showBitmap = CropViewUtils.compressBitmapForScale(pathName, scaleSize);
        resetBitmap();
//        int degree = CropViewUtils.readPictureDegree(pathName);
...
//        }
    ...
    public CustomCropView setBitmapForScale(byte[] data, int offset, int length, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(data, offset, length, scaleSize);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmapForScale(FileDescriptor fd, Rect outPadding, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(fd, outPadding, scaleSize);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmapForScale(Resources res, TypedValue value, InputStream is, Rect pad, int scaleSize) {
        showBitmap = CropViewUtils.compressBitmapForScale(res, value, is, pad, scaleSize);
        resetBitmap();
        return this;
    }

    public CustomCropView setBitmapForScale(InputStream is, Rect outPadding, int scaleSize) {
