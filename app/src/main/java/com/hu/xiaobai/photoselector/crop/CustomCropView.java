...
public class CustomCropView extends View {
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        maskColor = typedArray.getColor(R.styleable.CustomCropView_maskColor, Color.parseColor("#60000000"));
        ...
        radius = typedArray.getDimension(R.styleable.CustomCropView_radius, -1);
